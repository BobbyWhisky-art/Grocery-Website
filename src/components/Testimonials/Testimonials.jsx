        ...
        <section>
            <div className='max-w-[1400px] px-10 mx-auto py-20'>
                ...
                <div className='py-5 flex justify-end gap-x-3'>
                    <button className=' custom-prev text-2xl rounded-lg w-11 text-zinc-800 hover:bg-gradient-to-b hover:from-orange-200 hover:to-orange-500 h-11 bg-zinc-100 flex justify-center items-center hover:text-white cursor-pointer'>
                        <IoIosArrowBack />
                    </button>
                    <button className='custom-next text-2xl rounded-lg w-11 text-zinc-800 h-11 bg-zinc-100 flex justify-center items-center hover:bg-gradient-to-b hover:from-orange-200 hover:to-orange-500 hover:text-white cursor-pointer'>
                        <IoIosArrowForward />
                    </button>
                </div>
                        ...
                        review.map(item => {
                            return (
                                <SwiperSlide className='bg-zinc-100 rounded-xl p-8'>
                                    ...
                                    <div className='mt-10 min-h-[15vh]'> <p className='text-zinc-600'>{item.para}</p>
                                    </div>
                                </SwiperSlide>
                            )
                        })
