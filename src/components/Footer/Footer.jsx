        ...
        <footer className='bg-zinc-100 py-20'>
            <div className='flex  flex-wrap max-w-[1400px] mx-auto px-10 gap-y-10'>
                <div className='flex-1 basis-[300px]'>
                    <a href='#' className='text-3xl font-bold'>Gr<span className='text-orange-500 uppercase'>o</span>cery</a>
...
Stay Connected
                    ...
                    <p className='mt-6 text-zinc-600'>
                        ...
                        <div className='bg-white flex p-1 rounded-lg mt-6'>
                            <input className='h-[5vh] focus:outline-none pl-4 flex-1' type='email' name='email' id='email' autoComplete='off' placeholder='Email Address' />
